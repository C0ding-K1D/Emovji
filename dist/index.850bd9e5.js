...
// const showResults = state.data.prompt.slice(0, -9);
const submitBtn = document.querySelector('.btn__form');
const clear = function(parentEl) {
    parentEl.value = "";
};
...
const resultSave = function() {
    localStorage.setItem('result', JSON.stringify(inputValue, emoji));
};
const state = {
    data: {
...
},{}]},["1pDGL","1GgH0"], "1GgH0", "parcelRequire6aa0")
